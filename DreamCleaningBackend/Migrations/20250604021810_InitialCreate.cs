    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Subscriptions",
                columns: new[] { "Id", "Description", "DiscountPercentage", "FrequencyDays", "IsActive", "Name", "PriceModifier" },
                values: new object[,]
                {
                    { 1, "Single cleaning service", 0m, 0, true, "One-Time", 1.0m },
                    { 2, "Cleaning every week", 15m, 7, true, "Weekly", 1.0m },
                    { 3, "Cleaning every two weeks", 8m, 14, true, "Bi-Weekly", 1.0m },
                    { 4, "Cleaning once a month", 3m, 30, true, "Monthly", 1.0m }
                });
